...
$(document).ready(function () {
  ...
  function removeMobileOverlay() {
    $('.mobile-sticky-body-overlay').remove();
  ...
  if ($(window).width() < 768) {
    $(".sidebar-toggle").on("click", function () {
      if (!$("#body").hasClass("sidebar-mobile-in")) {
        $("body").css("overflow", "hidden");
        $('body').prepend('<div class="mobile-sticky-body-overlay"></div>');
        $("#body").addClass("sidebar-mobile-in").removeClass("sidebar-mobile-out");
      } else {
        removeMobileOverlay();
      }
    });
  ...
  $("#sidebar-toggler").on("click", function () {
    if ($(window).width() >= 768) {
      if (body.hasClass("sidebar-fixed-offcanvas") || body.hasClass("sidebar-static-offcanvas")) {
        ...
        body.toggleClass("sidebar-minified-out");
      }
    } else {
      if (!body.hasClass("sidebar-mobile-in")) {
        $("body").css("overflow", "hidden");
  ...
  // Handle initial state for tablet devices
